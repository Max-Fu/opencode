...
import type * as SDK from "@alphacode-ai/sdk/v2"
...
import { SessionShareTable } from "@alphacode-ai/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/ShareNext") {}
