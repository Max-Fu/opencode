...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | alphacode",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "alphacode açık logo",
  "notFound.logoDarkAlt": "alphacode koyu logo",
  ...
  "temp.title": "alphacode | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.feature.zen.beforeLink": "alphacode tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "alphacode TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı alphacode TUI",
  "temp.logoLightAlt": "alphacode açık logo",
  "temp.logoDarkAlt": "alphacode koyu logo",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman alphacode ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve alphacode seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "alphacode'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "alphacode hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir alphacode Gateway API anahtarı oluşturun",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için alphacode yapılandırmanızda "AlphaCode Go"\'yu sağlayıcı olarak seçin.',
