...
- Effect plugins import `@alphacode-ai/plugin/v2/effect`, not `@alphacode-ai/core`.
- Public domain values use generated `@alphacode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@alphacode-ai/plugin/v2/effect`.
