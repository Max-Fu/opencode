...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@alphacode-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@alphacode-ai/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-alphacode-tutorial": "1" },
    query: { debug: "1" },
  },
})
