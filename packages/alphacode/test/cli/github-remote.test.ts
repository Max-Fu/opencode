...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/alphacode.git")).toEqual({ owner: "sst", repo: "alphacode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/alphacode")).toEqual({ owner: "sst", repo: "alphacode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/alphacode.git")).toEqual({ owner: "sst", repo: "alphacode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/alphacode")).toEqual({ owner: "sst", repo: "alphacode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/alphacode.git")).toEqual({ owner: "sst", repo: "alphacode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/alphacode")).toEqual({ owner: "sst", repo: "alphacode" })
})
