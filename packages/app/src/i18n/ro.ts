export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode nu este instalat în această distribuție",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode nu este instalat în {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.alphacode.tagline": "Modele optimizate, fiabile",
  "dialog.provider.alphacodeGo.tagline": "Abonament accesibil pentru toți",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Vizitează",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "pentru a obține cheia ta API.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode este gata în {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode este gata.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode nu este instalat",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (alphacode.json)",
