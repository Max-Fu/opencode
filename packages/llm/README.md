...
Schema-first LLM core for alphacode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@alphacode-ai/llm"
import { OpenAI } from "@alphacode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@alphacode-ai/llm/providers"
