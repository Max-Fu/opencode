      ...
      >
        ...
        <div>
          ...
          >
            ...
            <div style={{ color: c.white }}>alphacode.ai/data</div>
          </div>
        </div>
      </div>
    </AbsoluteFill>
