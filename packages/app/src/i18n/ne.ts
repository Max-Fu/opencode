export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.alphacodeMissing": "Alphacode यस distro मा स्थापित छैन",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode {{distro}} मा स्थापित छैन",
  ...
  "dialog.provider.alphacode.note": "Claude, GPT, Gemini र थप सहित क्युरेट गरिएका मोडेलहरू",
  "dialog.provider.alphacode.tagline": "भरपर्दो अनुकूलित मोडेलहरू",
  "dialog.provider.alphacodeGo.tagline": "सबैको लागि कम लागत सदस्यता",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "तपाईँको API कुञ्जी सङ्कलन गर्न।",
  ...
  "dialog.plugins.empty": "alphacode.json मा कन्फिगर गरिएका प्लगइनहरू",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode {{distro}} मा तयार छ।",
  "wsl.onboarding.alphacodeReady": "AlphaCode तयार छ।",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode स्थापित छैन",
  ...
  "error.chain.checkConfig": "आफ्नो कन्फिगरेसन (alphacode.json) प्रदायक/मोडेल नामहरू जाँच गर्नुहोस्",
