...
export const dict = {
  ...
  "notFound.logoLightAlt": "alphacodeのロゴ（ライト）",
  "notFound.logoDarkAlt": "alphacodeのロゴ（ダーク）",
  ...
  "temp.logoLightAlt": "alphacodeのロゴ（ライト）",
  "temp.logoDarkAlt": "alphacodeのロゴ（ダーク）",
  ...
  "workspace.lite.subscription.selectProvider":
    "Go モデルを使用するには、alphacode の設定で「AlphaCode Go」をプロバイダーとして選択してください。",
