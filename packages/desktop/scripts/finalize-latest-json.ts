...
const releaseId = process.env.ALPHACODE_RELEASE
if (!releaseId) throw new Error("ALPHACODE_RELEASE is required")

const version = process.env.ALPHACODE_VERSION
if (!version) throw new Error("ALPHACODE_VERSION is required")
...
const macxTarGz = "alphacode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "alphacode-desktop-mac-arm64.app.tar.gz"
