...
import { base64Encode } from "@alphacode-ai/core/util/encode"
...
import { Session } from "@alphacode-ai/sdk/v2/client"
...
import { retry } from "@alphacode-ai/core/util/retry"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://alphacode.ai/desktop-feedback")}
      renderPanel={() =>
