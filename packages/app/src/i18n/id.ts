export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode belum terinstal di distro ini",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode belum terinstal di {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.alphacode.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.alphacodeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Kunjungi ",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode siap di {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode siap.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode belum terinstal",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (alphacode.json)",
