...
import { Event } from "@alphacode-ai/schema/project-directories"
import { ProjectCopy } from "@alphacode-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/ProjectCopy") {}
