...
brew install anomalyco/tap/alphacode # macOS i Linux (polecane, zawsze aktualne)
...
nix run nixpkgs#alphacode           # lub github:anomalyco/alphacode dla najnowszej gałęzi dev
```
...
AlphaCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/anomalyco/alphacode/releases) lub z [alphacode.ai/download](https://alphacode.ai/download).
...
Dowiedz się więcej o [agents](https://alphacode.ai/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji AlphaCode znajdziesz w [**dokumentacji**](https://alphacode.ai/docs).
...
**Dołącz do naszej społeczności** [Discord](https://discord.gg/alphacode) | [X.com](https://x.com/alphacode)
