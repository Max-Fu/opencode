---
title: Teilen
description: Teile AlphaCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu AlphaCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht AlphaCode Folgendes:
...
AlphaCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt AlphaCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`alphacode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du alphacode in deiner Organisation einsetzt.
