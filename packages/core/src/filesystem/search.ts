...
export class Service extends Context.Service<Service, Interface>()("@alphacode/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.ALPHACODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
