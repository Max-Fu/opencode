export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.alphacodeCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode በ{{distro}}] ውስጥ አልተጫነም",
  ...
  "dialog.provider.alphacode.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.alphacode.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.alphacodeGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "provider.connect.alphacodeZen.line1": "AlphaCode ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.alphacodeZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.alphacodeZen.visit.prefix": "ጎብኝ ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  ...
  "dialog.plugins.empty": "plugins በ alphacode.json የተዋቀሩ",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.alphacodeReady": "AlphaCode ዝግጁ ነው።",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCodeአልተጫነም",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (alphacode.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
