export const dict = {
  ...
  "dialog.provider.alphacode.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.alphacode.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.alphacodeGo.tagline": "Edullinen tilaus kaikille",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Avaa ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " ja hae API-avaimesi.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään alphacode.json-tiedostossa",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode on valmis jakelussa {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCodea ei ole asennettu",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (alphacode.json) palveluntarjoajien ja mallien nimet",
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCodea ei ole asennettu jakeluun {{distro}}",
