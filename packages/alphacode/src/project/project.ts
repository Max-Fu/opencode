...
import { ProjectDirectoryTable, ProjectTable } from "@alphacode-ai/core/project/sql"
import { ProjectDirectories } from "@alphacode-ai/core/project/directories"
...
import { which } from "@alphacode-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.ALPHACODE_FAKE_VCS)
