...
const DEFAULT_SERVER_URL_KEY = "alphacode.settings.dat:defaultServerUrl"
...
const getCurrentUrl = () => {
  if (location.hostname.includes("alphacode.ai")) return "http://localhost:4096"
  if (import.meta.env.DEV)
    return `http://${import.meta.env.VITE_ALPHACODE_SERVER_HOST ?? "localhost"}:${import.meta.env.VITE_ALPHACODE_SERVER_PORT ?? "4096"}`
