...
สร้าง `.alphacode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ AlphaCode:
...
- ระดับผู้ใช้ (Global): `~/.config/alphacode/commands/`
- ระดับโปรเจ็กต์: `.alphacode/commands/`
...
AlphaCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
