---
title: TUI
description: Brug af AlphaCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AlphaCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre AlphaCode starter TUI for den nuværende mappe.
...
Når du bruger AlphaCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til AlphaCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut AlphaCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `alphacode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe AlphaCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `alphacode.default`.
