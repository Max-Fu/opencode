---
title: TUI
description: استخدام واجهة المستخدم TUI في AlphaCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر AlphaCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل AlphaCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة AlphaCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى AlphaCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من AlphaCode. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `alphacode.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار AlphaCode بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `alphacode.default`.
