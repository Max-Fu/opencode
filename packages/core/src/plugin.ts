...
import type { Plugin as PluginRuntime } from "@alphacode-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/v2/Plugin") {}
