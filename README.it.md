...
brew install anomalyco/tap/alphacode # macOS e Linux (consigliato, sempre aggiornato)
...
nix run nixpkgs#alphacode           # oppure github:anomalyco/alphacode per l’ultima branch di sviluppo
```
...
AlphaCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/anomalyco/alphacode/releases) oppure da [alphacode.ai/download](https://alphacode.ai/download).
...
Scopri di più sugli [agenti](https://alphacode.ai/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare AlphaCode, [**consulta la nostra documentazione**](https://alphacode.ai/docs).
...
**Unisciti alla nostra community** [Discord](https://discord.gg/alphacode) | [X.com](https://x.com/alphacode)
