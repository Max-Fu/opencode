---
title: Compartir
description: Comparte tus conversaciones AlphaCode.
---

La función para compartir de AlphaCode te permite crear enlaces públicos a tus conversaciones de AlphaCode, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, AlphaCode:
...
AlphaCode admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, AlphaCode usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `alphacode.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de alphacode en su organización.
