export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode není v této distribuci nainstalováno",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode není nainstalován v {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.alphacode.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.alphacodeGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Návštěva ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode je připraveno v {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode je připraven.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode není nainstalováno",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (alphacode.json).",
