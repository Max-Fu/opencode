      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://alphacode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>alphacode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g alphacode-ai")}>
                <code>
                  npm i -g <strong>alphacode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g alphacode-ai")}>
                <code>
                  bun add -g <strong>alphacode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/alphacode")}>
                <code>
                  brew install <strong>anomalyco/tap/alphacode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S alphacode")}>
                <code>
                  paru -S <strong>alphacode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask alphacode-desktop")}>
                <code>
                  brew install --cask <strong>alphacode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
