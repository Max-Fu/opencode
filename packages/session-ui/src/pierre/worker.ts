...
import { registerAlphaCodeTheme } from "@alphacode-ai/ui/context/marked-theme-register"

registerAlphaCodeTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for AlphaCode, as I think 8 might be
