---
title: TUI
description: Korištenje korisničkog interfejsa AlphaCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AlphaCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje AlphaCode pokreće TUI za trenutni direktorij.
...
Kada koristite AlphaCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u AlphaCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz AlphaCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `alphacode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo AlphaCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `alphacode.default`.
