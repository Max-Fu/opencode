...
brew install anomalyco/tap/alphacode # macOS و Linux (موصى به، دائما محدث)
...
nix run nixpkgs#alphacode           # او github:anomalyco/alphacode لاحدث فرع dev
```
...
يتوفر AlphaCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/anomalyco/alphacode/releases) او من [alphacode.ai/download](https://alphacode.ai/download).
...
تعرف على المزيد حول [agents](https://alphacode.ai/docs/agents).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط AlphaCode، [**راجع التوثيق**](https://alphacode.ai/docs).
...
**انضم الى مجتمعنا** [Discord](https://discord.gg/alphacode) | [X.com](https://x.com/alphacode)
