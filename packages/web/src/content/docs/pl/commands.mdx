...
Utwórz `.alphacode/commands/test.md`:
...
Możesz zdefiniować polecenia w `alphacode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji alphacode:
...
- Globalnie: `~/.config/alphacode/commands/`
- Na projekt: `.alphacode/commands/`
...
alphacode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
