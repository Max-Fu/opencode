---
title: Dijeljenje
description: Dijelite AlphaCode razgovore javnim linkovima.
---

AlphaCode opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, AlphaCode:
...
AlphaCode podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, AlphaCode koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `alphacode.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju alphacode u organizaciji.
