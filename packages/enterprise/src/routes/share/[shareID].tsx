import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@alphacode-ai/sdk/v2"
import { SessionTurn } from "@alphacode-ai/session-ui/session-turn"
import { SessionReview } from "@alphacode-ai/session-ui/session-review"
import { DataProvider } from "@alphacode-ai/session-ui/context"
import { FileComponentProvider } from "@alphacode-ai/ui/context/file"
import { WorkerPoolProvider } from "@alphacode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@alphacode-ai/ui/logo"
import { IconButton } from "@alphacode-ai/ui/icon-button"
import { ProviderIcon } from "@alphacode-ai/ui/provider-icon"
import { iife } from "@alphacode-ai/core/util/iife"
import { Binary } from "@alphacode-ai/core/util/binary"
import { NamedError } from "@alphacode-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@alphacode-ai/ui/tabs"
import { MessageNav } from "@alphacode-ai/session-ui/message-nav"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@alphacode-ai/session-ui/pierre/worker").then((m) => ({
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/alphacode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://alphacode.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
