export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.alphacodeCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode δεν είναι εγκατεστημένο στο {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.alphacode.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.alphacodeGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode είναι έτοιμο.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode δεν έχει εγκατασταθεί",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (alphacode.json) ονόματα παρόχου/μοντέλων",
