...
import { AbsolutePath, type DeepMutable } from "@alphacode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".alphacode", "plans", "*.md")]: "allow",
