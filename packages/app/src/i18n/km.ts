export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode មិនត្រូវបានដំឡើងនៅក្នុង distro នេះទេ។",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode ត្រូវបានដំឡើង ប៉ុន្តែមិនអាចដំណើរការបានទេ។",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode មិនត្រូវបានដំឡើងនៅក្នុង {{distro}} ទេ។",
  ...
  "dialog.provider.alphacode.note": "ម៉ូដែលដែលបានជ្រើសរើសរួមមាន Claude, GPT, Gemini និងច្រើនទៀត",
  "dialog.provider.alphacode.tagline": "ម៉ូដែលដែលបានកែលម្អដែលអាចទុកចិត្តបាន។",
  "dialog.provider.alphacodeGo.tagline": "ការជាវតម្លៃទាបសម្រាប់អ្នករាល់គ្នា",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "ទស្សនា",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "ដើម្បីប្រមូលសោ API របស់អ្នក។",
  ...
  "dialog.plugins.empty": "កម្មវិធីជំនួយដែលបានកំណត់រចនាសម្ព័ន្ធនៅក្នុង alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode គឺរួចរាល់នៅក្នុង {{distro}} ។",
  "wsl.onboarding.alphacodeReady": "AlphaCode គឺរួចរាល់។",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode មិនត្រូវបានដំឡើងទេ។",
  ...
  "error.chain.checkConfig": "ពិនិត្យការកំណត់រចនាសម្ព័ន្ធរបស់អ្នក (alphacode.json) អ្នកផ្តល់សេវា/ឈ្មោះម៉ូដែល",
