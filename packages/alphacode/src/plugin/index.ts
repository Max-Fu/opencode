...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "alphacode-gitlab-auth"
import { PoeAuthPlugin } from "alphacode-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/Plugin") {}
