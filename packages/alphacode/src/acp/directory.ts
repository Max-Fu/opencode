...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@alphacode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@alphacode/ACPDirectory") {}
