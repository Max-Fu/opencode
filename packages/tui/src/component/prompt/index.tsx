...
import { registerAlphacodeSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@alphacode-ai/sdk/v2"
...
import { ALPHACODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useAlphacodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.ALPHACODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
