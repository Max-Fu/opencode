...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips alphacode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-alphacode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-alphacode-directory")).toBeNull()
      expect(result.get("x-alphacode-workspace")).toBeNull()
