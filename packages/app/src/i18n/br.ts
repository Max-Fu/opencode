export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "O alphacode não está instalado nesta distribuição",
  "desktop.wsl.error.alphacodeCannotRun": "O alphacode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.alphacodeNotInstalled": "O AlphaCode não está instalado em {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.alphacode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.alphacodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Visite ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " para obter sua chave de API.",
  ...
  "dialog.plugins.empty": "Plugins configurados em alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "O AlphaCode está pronto em {{distro}}.",
  "wsl.onboarding.alphacodeReady": "O AlphaCode está pronto.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode não instalado",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (alphacode.json)",
