...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new AlphacodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class Global extends HeyApiClient {
   ...
   * Upgrade alphacode
   *
   * Upgrade alphacode to the specified version or latest if not specified.
   */
...
export class AlphacodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<AlphacodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    AlphacodeClient.__registry.set(this, args?.key)
  }
