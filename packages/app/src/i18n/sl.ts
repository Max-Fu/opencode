export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode ni nameščen v tej distribuciji",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode ni nameščen v {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.alphacode.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.alphacodeGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Obisk ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " za prevzem ključa API.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode je pripravljen v {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode je pripravljen.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode ni nameščen",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (alphacode.json).",
