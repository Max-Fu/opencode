export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode არ არის დაინსტალირებული {{distro}}",
  ...
  "dialog.provider.alphacode.note": "კურირებული მოდელები, მათ შორის Claude, GPT, Gemini და სხვა",
  "dialog.provider.alphacode.tagline": "სანდო ოპტიმიზებული მოდელები",
  "dialog.provider.alphacodeGo.tagline": "დაბალფასიანი გამოწერა ყველასთვის",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "ეწვიეთ ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " თქვენი API გასაღების შესაგროვებლად.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია alphacode.json-ში",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode მზად არის {{distro}}-ში.",
  "wsl.onboarding.alphacodeReady": "AlphaCode მზად არის.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode არ არის დაინსტალირებული",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (alphacode.json) პროვაიდერის/მოდელების სახელები",
