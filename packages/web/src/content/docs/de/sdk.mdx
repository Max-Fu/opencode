---
title: SDK
description: Typsicherer JS-Client fuer den alphacode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das alphacode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und alphacode programmatisch steuern.
...
Erstelle eine alphacode-Instanz:
...
`alphacode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn alphacode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
