...
> current private `@alphacode-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@alphacode-ai/ai`
...
- Secondary audience: AlphaCode and other durable agent runtimes
...
import { LLM } from "@alphacode-ai/ai"
import { OpenAI } from "@alphacode-ai/ai/providers/openai"
...
```ts
import { Message } from "@alphacode-ai/ai"
...
import { LLM, Tool } from "@alphacode-ai/ai"
...
AlphaCode and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@alphacode-ai/ai/promise"
import { OpenAI } from "@alphacode-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@alphacode-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@alphacode-ai/ai/provider"
...
@alphacode-ai/ai/promise
  Promise/AsyncIterable LLM facade

@alphacode-ai/ai/schema
  serializable domain schemas

@alphacode-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@alphacode-ai/ai/providers/openai
@alphacode-ai/ai/providers/anthropic
@alphacode-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@alphacode-ai/llm`                      | `@alphacode-ai/ai`                                           |
...
AlphaCode should migrate to `generateTurn` / `streamTurn`, preserving its durable
