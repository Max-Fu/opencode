...
import type { Data, Definition, Payload } from "@alphacode-ai/schema/event"
...
import { Durable } from "@alphacode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@alphacode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@alphacode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/Event") {}
