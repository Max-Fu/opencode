...
export const TypeId: TypeId = "~@alphacode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@alphacode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@alphacode-ai/effect-sqlite-node/NodeSqliteClient")
