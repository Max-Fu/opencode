...
Practical reference for the current tool-migration state in `packages/alphacode`.
...
Tool tests should use the existing Effect helpers in `packages/alphacode/test/lib/effect.ts`:
