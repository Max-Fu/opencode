export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode տեղադրված չէ {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.alphacode.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.alphacodeGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Այցելություն ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են alphacode.json-ում",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.alphacodeReady": "AlphaCode պատրաստ է։",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode տեղադրված չէ",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (alphacode.json) մատակարարի/մոդելի անունները",
