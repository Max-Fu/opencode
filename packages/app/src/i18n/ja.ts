export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "このディストリビューションにはalphacodeがインストールされていません",
  "desktop.wsl.error.alphacodeCannotRun": "alphacodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.alphacodeNotInstalled": "{{distro}}にはAlphaCodeがインストールされていません",
  ...
  "dialog.provider.alphacode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.alphacode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.alphacodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.alphacodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.alphacodeZen.visit.prefix": " ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "alphacode.jsonで設定されたプラグイン",
  ...
  "wsl.onboarding.alphacodeReadyIn": "{{distro}}内のAlphaCodeの準備ができました。",
  "wsl.onboarding.alphacodeReady": "AlphaCodeの準備ができました。",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCodeがインストールされていません",
  ...
  "error.chain.checkConfig": "config (alphacode.json) のプロバイダー/モデル名を確認してください",
