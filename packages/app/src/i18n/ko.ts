export const dict = {
  ...
  "dialog.provider.alphacode.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.alphacode.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.alphacodeGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.alphacodeZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.alphacodeZen.visit.prefix": "다음 ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "dialog.plugins.empty": "alphacode.json에 구성된 플러그인",
  ...
  "error.chain.checkConfig": "구성(alphacode.json)의 공급자/모델 이름을 확인하세요",
  ...
  "wsl.onboarding.alphacodeReadyIn": "{{distro}}에서 AlphaCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.alphacodeReady": "AlphaCode가 준비되었습니다.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode가 설치되지 않음",
  ...
  "desktop.wsl.error.alphacodeMissing": "이 배포판에 alphacode가 설치되어 있지 않습니다",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.alphacodeNotInstalled": "{{distro}}에 AlphaCode가 설치되어 있지 않습니다",
