...
import defaultSoundPath from "@alphacode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@alphacode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@alphacode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@alphacode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@alphacode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@alphacode-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_PACK_ID = "alphacode.default"
