export const dict = {
  ...
  "dialog.provider.alphacode.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.alphacode.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.alphacodeGo.tagline": "Abbonamento economico per tutti",
  ...
  "provider.connect.alphacodeZen.visit.suffix": " per ottenere la tua chiave API.",
  ...
  "dialog.plugins.empty": "Plugin configurati in alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode è pronto in {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode è pronto.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode non installato",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (alphacode.json)",
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode non è installato in questa distribuzione",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode non è installato in {{distro}}",
