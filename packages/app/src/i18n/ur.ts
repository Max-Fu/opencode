export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "اس ڈسٹری بیوشن میں alphacode انسٹال نہیں ہے",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.alphacodeNotInstalled": "{{distro}} میں AlphaCode انسٹال نہیں ہے",
  ...
  "dialog.provider.alphacode.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.alphacode.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.alphacodeGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  ...
  "dialog.plugins.empty": "alphacode.json میں کنفیگر کردہ پلگ انز",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.alphacodeReady": "AlphaCode تیار ہے۔",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode انسٹال نہیں ہے۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (alphacode.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
