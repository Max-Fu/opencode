export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode no está instalado en esta distribución",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode no está instalado en {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.alphacode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.alphacodeGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.alphacodeZen.visit.suffix": " para obtener tu clave API.",
  ...
  "dialog.plugins.empty": "Plugins configurados en alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode está listo en {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode está listo.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode no está instalado",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (alphacode.json)",
