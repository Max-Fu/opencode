...
Opprett `.alphacode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom AlphaCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i AlphaCode [config](/docs/config):
...
- Per prosjekt: `.alphacode/commands/`
...
AlphaCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
