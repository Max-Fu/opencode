...
export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode bu dağıtımda kurulu değil",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode, {{distro}} içinde kurulu değil",
  ...
  "dialog.provider.alphacode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.alphacode.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.alphacodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.alphacodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "dialog.plugins.empty": "Eklentiler alphacode.json içinde yapılandırılır",
  ...
  "wsl.onboarding.alphacodeReadyIn": "{{distro}} içinde AlphaCode hazır.",
  "wsl.onboarding.alphacodeReady": "AlphaCode hazır.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode kurulu değil",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (alphacode.json) sağlayıcı/model adlarını kontrol edin",
