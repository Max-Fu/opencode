export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "اس ڈسٹرو وچ alphacode انسٹال نئیں اے",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.alphacodeNotInstalled": "{{distro}} وچ AlphaCode انسٹال نئیں اے",
  ...
  "dialog.provider.alphacode.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.alphacode.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.alphacodeGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "ویکھو ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  ...
  "dialog.plugins.empty": "alphacode.json وچ سیٹ کیتے پلگ اِن",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.alphacodeReady": "AlphaCode تیار اے۔",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode انسٹال نئیں کیتا گیا",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (alphacode.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
