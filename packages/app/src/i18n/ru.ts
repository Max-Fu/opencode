export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode не установлен в этом дистрибутиве",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode установлен, но его не удалось запустить",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode не установлен в {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.alphacode.tagline": "Надёжные оптимизированные модели",
  "dialog.provider.alphacodeGo.tagline": "Доступная подписка для всех",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Посетите ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": ", чтобы получить ключ API.",
  ...
  "dialog.plugins.empty": "Плагины настроены в alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode в {{distro}} готов к работе.",
  "wsl.onboarding.alphacodeReady": "AlphaCode готов к работе.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode не установлен",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (alphacode.json)",
