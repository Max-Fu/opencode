export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode is niet geïnstalleerd in {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.alphacode.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.alphacodeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Ga naar ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " om je API-sleutel op te halen.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode is gereed in {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode is klaar.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode niet geïnstalleerd",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (alphacode.json)",
