...
class Database extends Context.Service<Database, DatabaseShape>()("@alphacode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@alphacode/example/UserStore") {
