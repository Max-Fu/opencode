...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@alphacode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/v2/ToolRegistry") {}
