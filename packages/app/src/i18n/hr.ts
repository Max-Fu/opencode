...
const desktop = [
  ...
  "alphacode nije instaliran u ovoj distribuciji",
  "alphacode je instaliran, ali se ne može pokrenuti",
...
export const dict = {
  ...
  "dialog.provider.alphacode.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.alphacode.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.alphacodeGo.tagline": "Niska cijena pretplate za sve",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Posjetiti",
  "provider.connect.alphacodeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "da preuzmete svoj ključ API.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode je spreman u {{distro}}.",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (alphacode.json).",
