export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode tidak dipasang dalam distro ini",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode tidak dipasang dalam {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.alphacode.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.alphacodeGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Layari",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode sedia digunakan.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode belum dipasang",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (alphacode.json) nama penyedia/model",
