...
const desktop = [
  ...
  "Az alphacode nincs telepítve ebben a disztribúcióban",
  "Az alphacode telepítve van, de nem futtatható",
...
export const dict = {
  ...
  "dialog.provider.alphacode.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.alphacode.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.alphacodeGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Látogatás",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  ...
  "dialog.plugins.empty": "Az alphacode.json fájlban konfigurált beépülő modulok",
  ...
  "wsl.onboarding.alphacodeReadyIn": "A AlphaCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.alphacodeReady": "A AlphaCode készen áll.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "A AlphaCode nincs telepítve",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (alphacode.json) szolgáltató/modell nevét",
