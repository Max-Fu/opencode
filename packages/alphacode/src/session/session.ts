...
import { Slug } from "@alphacode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@alphacode-ai/llm"
...
import { locationServiceMapLayer } from "@alphacode-ai/core/location-services"
...
import { PartTable, SessionTable } from "@alphacode-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@alphacode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".alphacode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/Session") {}
