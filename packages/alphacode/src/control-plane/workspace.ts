...
import { EventSequenceTable, EventTable } from "@alphacode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@alphacode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ALPHACODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ALPHACODE_WORKSPACE_ID: config.id,
        ALPHACODE_EXPERIMENTAL_WORKSPACES: "true",
