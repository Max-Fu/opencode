...
Kreiraj `.alphacode/commands/test.md`:
...
Možete dodati prilagođene komande kroz AlphaCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom AlphaCode [config](/docs/config):
...
- Globalno: `~/.config/alphacode/commands/`
- Po projektu: `.alphacode/commands/`
...
AlphaCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
