...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[AlphaCode](https://alphacode.ai)")).toBe(
    '<p><a href="https://alphacode.ai" class="external-link" target="_blank" rel="noopener noreferrer">AlphaCode</a></p>\n',
  )
})
