...
import type { EffectDrizzleSqlite } from "@alphacode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/ProjectDirectories") {}
