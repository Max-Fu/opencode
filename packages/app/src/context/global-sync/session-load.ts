...
import type { AlphacodeClient } from "@alphacode-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: AlphacodeClient; directory: string; limit: number }) {
  try {
