 ...
 *   "@alphacode/ServerAuthConfig",
 *   {
 *     password: Config.string("ALPHACODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ALPHACODE_SERVER_USERNAME").pipe(Config.withDefault("alphacode")),
 *   },
 * ) {}
 *
