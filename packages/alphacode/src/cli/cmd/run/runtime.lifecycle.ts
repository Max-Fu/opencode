...
import { openEditor } from "@alphacode-ai/tui/editor"
import { registerAlphacodeKeymap } from "@alphacode-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerAlphacodeKeymap(keymap, renderer, input.tuiConfig)
