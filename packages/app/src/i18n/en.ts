...
export const dict = {
  ...
  "dialog.provider.alphacode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.alphacode.tagline": "Reliable optimized models",
  "dialog.provider.alphacodeGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Visit ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " to collect your API key.",
  ...
  "dialog.plugins.empty": "Plugins configured in alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode is ready in {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode is ready.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode not installed",
  ...
  "error.chain.checkConfig": "Check your config (alphacode.json) provider/model names",
