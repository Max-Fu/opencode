...
import { isSessionNotFoundError, isUnauthorizedError, AlphaCode } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = AlphaCode.make({ baseUrl: "http://localhost:3000" })
