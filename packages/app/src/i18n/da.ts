export const dict = {
  ...
  "dialog.provider.alphacode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.alphacode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.alphacodeGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Besøg ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " for at hente din API-nøgle.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i alphacode.json",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode er ikke installeret",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (alphacode.json)",
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode er ikke installeret i denne distribution",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode er installeret, men kunne ikke køre",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode er ikke installeret i {{distro}}",
