...
import { AccountStateTable, AccountTable } from "@alphacode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/AccountRepo") {}
