...
import type { retry } from "@alphacode-ai/core/util/retry"
import type { OpenCodeEvent, SessionApi } from "@opencode-ai/client/promise"
import type { Message, AlphacodeClient, Part, Session } from "@alphacode-ai/sdk/v2/client"
...
describe("server session", () => {
  ...
  test("extends a current page to include the user for split assistant turns", async () => {
    ...
    const store = createServerSession({} as AlphacodeClient, {} as SessionApi, messageApi)
    store.remember(session("root"))
