...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "ALPHACODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/alphacode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/alphacode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/alphacode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/alphacode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const ALPHACODE_DB|ALPHACODE_DB|ALPHACODE_DEV|Global\\.Path\\.data|data =" in packages/alphacode/src (115 matches)',
  },
] as const
