...
import { Entry, FileSystem, FindInput, Match } from "@alphacode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@alphacode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/v2/FileSystem") {}
