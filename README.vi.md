...
brew install anomalyco/tap/alphacode # macOS và Linux (khuyên dùng, luôn cập nhật)
...
nix run nixpkgs#alphacode           # hoặc github:anomalyco/alphacode cho nhánh dev mới nhất
```
...
AlphaCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/anomalyco/alphacode/releases) hoặc [alphacode.ai/download](https://alphacode.ai/download).
...
Tìm hiểu thêm về [agents](https://alphacode.ai/docs/agents).

### Tài liệu

Để biết thêm thông tin về cách cấu hình AlphaCode, [**hãy truy cập tài liệu của chúng tôi**](https://alphacode.ai/docs).
...
**Tham gia cộng đồng của chúng tôi** [Discord](https://discord.gg/alphacode) | [X.com](https://x.com/alphacode)
