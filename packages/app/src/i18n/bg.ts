export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode не е инсталиран в тази дистрибуция",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode е инсталиран, но не може да стартира",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode не е инсталиран в {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Подбрани модели, включително Claude, GPT, Gemini и други",
  "dialog.provider.alphacode.tagline": "Надеждни оптимизирани модели",
  "dialog.provider.alphacodeGo.tagline": "Абонамент на ниска цена за всеки",
  ...
  "provider.connect.alphacodeZen.visit.suffix": "за да вземете своя ключ API.",
  ...
  "dialog.plugins.empty": "Добавки, конфигурирани в alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode е готов в {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode е готов.",
  ...
  "error.chain.checkConfig": "Проверете имената на доставчика/модела на вашата конфигурация (alphacode.json).",
