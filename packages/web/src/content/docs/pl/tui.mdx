---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala alphacode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

alphacode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie alphacode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI alphacode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do alphacode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij alphacode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `alphacode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo AlphaCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `alphacode.default`.
