...
export const dict = {
  ...
  "notFound.logoLightAlt": "alphacode 淺色標誌",
  "notFound.logoDarkAlt": "alphacode 深色標誌",
  ...
  "temp.logoLightAlt": "alphacode 淺色標誌",
  "temp.logoDarkAlt": "alphacode 深色標誌",
  ...
  "workspace.lite.subscription.selectProvider":
    "在您的 alphacode 設定中選擇「AlphaCode Go」作為提供商，即可使用 Go 模型。",
