...
`.alphacode/commands/test.md` oluştur:
...
alphacode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

alphacode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/alphacode/commands/`
- Proje başına: `.alphacode/commands/`
...
alphacode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
