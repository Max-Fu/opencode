...
const desktop = [
  ...
  "{{distro}} jau pridėtas",
  "alphacode šiame distributyve neįdiegtas",
  "alphacode įdiegtas, bet jo paleisti nepavyko",
...
export const dict = {
  ...
  "dialog.provider.alphacode.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.alphacode.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.alphacodeGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Aplankykite",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode yra paruoštas {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode yra paruoštas.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode neįdiegtas",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (alphacode.json) teikėjo / modelio pavadinimus",
