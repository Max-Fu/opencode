export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode chưa được cài đặt trong {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.alphacode.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.alphacodeGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Truy cập ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " để lấy khóa API của bạn.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode đã sẵn sàng.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode chưa được cài đặt",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (alphacode.json) của bạn",
