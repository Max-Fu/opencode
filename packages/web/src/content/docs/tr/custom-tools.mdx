---
title: Özel Araçlar
description: LLM'un alphacode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. alphacode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.alphacode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/alphacode/tools/` içine yerleştirerek.
