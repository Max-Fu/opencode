...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/alphacode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy alphacode service removed
