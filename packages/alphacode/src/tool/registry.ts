...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@alphacode-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/ToolRegistry") {}
