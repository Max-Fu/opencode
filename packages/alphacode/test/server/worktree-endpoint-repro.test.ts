...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      ALPHACODE_EXPERIMENTAL_WORKSPACES: Flag.ALPHACODE_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.ALPHACODE_EXPERIMENTAL_WORKSPACES = original.ALPHACODE_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
