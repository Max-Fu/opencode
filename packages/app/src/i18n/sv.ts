export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode är inte installerat i den här distributionen",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode är installerat men kunde inte köras",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode är inte installerat i {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.alphacode.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.alphacodeGo.tagline": "Lågprisprenumeration för alla",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Besök ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " för att hämta din API-nyckel.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode är redo i {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode är redo.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode är inte installerat",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (alphacode.json)",
