...
import { createMarkdownParser } from "@alphacode-ai/ui/context/marked-parser"
import { AlphaCodeTheme } from "@alphacode-ai/ui/context/marked-theme"
import {
  bundledLanguages,
  createHighlighter,
  getTokenStyleObject,
...
function getHighlighter() {
  return (highlighter ??= createHighlighter({ themes: [AlphaCodeTheme], langs: [] }))
}
