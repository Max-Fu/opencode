export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "इस डिस्ट्रो में alphacode इंस्टॉल नहीं है",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.alphacodeNotInstalled": "{{distro}} में AlphaCode इंस्टॉल नहीं है",
  ...
  "dialog.provider.alphacode.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.alphacode.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.alphacodeGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "provider.connect.alphacodeZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.alphacodeZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  ...
  "dialog.plugins.empty": "प्लगइन alphacode.json में कॉन्फ़िगर किए गए हैं",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode {{distro}} में तैयार है।",
  "wsl.onboarding.alphacodeReady": "AlphaCode तैयार है।",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode स्थापित नहीं है",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (alphacode.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
