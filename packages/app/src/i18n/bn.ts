export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.alphacodeMissing": "এই ডিস্ট্রোতে alphacode ইনস্টল করা নেই",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode {{distro}} এ ইনস্টল করা নেই",
  ...
  "dialog.provider.alphacode.note": "Claude, GPT, Gemini এবং আরও অনেক কিছু সহ কিউরেট করা মডেল",
  "dialog.provider.alphacode.tagline": "নির্ভরযোগ্য অপ্টিমাইজ করা মডেল",
  "dialog.provider.alphacodeGo.tagline": "সবার জন্য কম খরচে সাবস্ক্রিপশন",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "ভিজিট করুন",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "আপনার API কী সংগ্রহ করতে।",
  ...
  "dialog.plugins.empty": "alphacode.json এ কনফিগার করা প্লাগইন",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.alphacodeReady": "AlphaCode প্রস্তুত।",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode ইনস্টল করা নেই",
  ...
  "error.chain.checkConfig": "আপনার কনফিগারেশন (alphacode.json) প্রদানকারী/মডেলের নাম পরীক্ষা করুন",
