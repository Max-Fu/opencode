export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode غير مثبت في {{distro}}",
  ...
  "dialog.provider.alphacode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.alphacode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.alphacodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode جاهز في {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode جاهز.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode غير مثبت",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (alphacode.json)",
