...
Brug den til at bygge integrasjoner og kontrollere alphacode programmatisk.
...
Opret en forekomst av alphacode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `alphacode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av alphacode, kan du oprete en klientforekomst for at koble til den:
