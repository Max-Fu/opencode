...
brew install anomalyco/tap/alphacode # macOS 및 Linux (권장, 항상 최신)
...
nix run nixpkgs#alphacode           # 또는 github:anomalyco/alphacode 로 최신 dev 브랜치
```
...
AlphaCode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/alphacode/releases) 에서 직접 다운로드하거나 [alphacode.ai/download](https://alphacode.ai/download) 를 이용하세요.
...
[agents](https://alphacode.ai/docs/agents) 에 대해 더 알아보세요.

### 문서

AlphaCode 설정에 대한 자세한 내용은 [**문서**](https://alphacode.ai/docs) 를 참고하세요.
...
**커뮤니티에 참여하기** [Discord](https://discord.gg/alphacode) | [X.com](https://x.com/alphacode)
