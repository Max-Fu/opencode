export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "Bu distribütivdə alphacode quraşdırılmayıb",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode {{distro}} distribütivində quraşdırılmayıb",
  ...
  "dialog.provider.alphacode.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.alphacode.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.alphacodeGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər alphacode.json-da konfiqurasiya edilib",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode {{distro}}-də hazırdır.",
  "wsl.onboarding.alphacodeReady": "AlphaCode hazırdır.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode quraşdırılmayıb",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (alphacode.json) provayder/model adlarını yoxlayın",
