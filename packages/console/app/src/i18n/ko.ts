...
export const dict = {
  ...
  "notFound.logoLightAlt": "alphacode 밝은 로고",
  "notFound.logoDarkAlt": "alphacode 어두운 로고",
  ...
  "temp.logoLightAlt": "alphacode 밝은 로고",
  "temp.logoDarkAlt": "alphacode 어두운 로고",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go 모델을 사용하려면 alphacode 설정에서 "AlphaCode Go"를 공급자로 선택하세요.',
