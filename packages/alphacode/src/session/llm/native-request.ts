import type { JsonSchema, LLMRequest, ProviderMetadata } from "@alphacode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@alphacode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @alphacode-ai/llm request objects from alphacode's session/AI SDK-shaped data.
  return LLM.request({
