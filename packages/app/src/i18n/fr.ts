export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode n'est pas installé dans cette distribution",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode n'est pas installé dans {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.alphacode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.alphacodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Visitez ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode est prêt dans {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode est prêt.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode non installé",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (alphacode.json)",
