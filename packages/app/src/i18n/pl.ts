export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "Program alphacode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.alphacodeCannotRun": "Program alphacode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode nie jest zainstalowany w dystrybucji {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.alphacode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.alphacodeGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode jest gotowy.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode nie jest zainstalowany",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (alphacode.json)",
