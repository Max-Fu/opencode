export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode nav instalēts {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.alphacode.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.alphacodeGo.tagline": "Zemas cenas abonements visiem",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Apmeklējiet",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode ir gatavs.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode nav instalēts",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (alphacode.json) pakalpojuma/modela nosaukumus",
