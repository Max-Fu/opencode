...
export const dict = {
  ...
  "dialog.provider.alphacode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.alphacode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.alphacodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  ...
  "dialog.plugins.empty": "In alphacode.json konfigurierte Plugins",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode ist in {{distro}} bereit.",
  "wsl.onboarding.alphacodeReady": "AlphaCode ist bereit.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode nicht installiert",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (alphacode.json)",
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode ist in {{distro}} nicht installiert",
