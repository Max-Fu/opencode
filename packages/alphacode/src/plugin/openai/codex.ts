import type { Hooks, PluginInput } from "@alphacode-ai/plugin"
...
import { OauthCallbackPage } from "@alphacode-ai/core/oauth/page"
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "alphacode"
      output.headers["User-Agent"] = `alphacode/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
