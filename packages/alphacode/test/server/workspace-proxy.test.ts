...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips alphacode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-alphacode-directory"]).toBeUndefined()
      expect(forwarded["x-alphacode-workspace"]).toBeUndefined()
