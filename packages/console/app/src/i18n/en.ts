export const dict = {
  ...
  "notFound.title": "Not Found | alphacode",
  ...
  "temp.title": "alphacode | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by alphacode",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "alphacode TUI with the tokyonight theme",
  "temp.screenshot.alt": "alphacode TUI with tokyonight theme",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with alphacode whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select alphacode",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start alphacode and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing alphacode services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an alphacode Gateway API key",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "AlphaCode Go" as the provider in your alphacode configuration to use Go models.',
