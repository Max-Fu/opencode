...
beforeAll(async () => {
  ...
  mock.module("@alphacode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@alphacode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@alphacode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@alphacode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
