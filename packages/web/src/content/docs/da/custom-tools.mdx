...
description: Opret værktøjer, som LLM kan kalde alphacode ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med alphacodes [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.alphacode/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/alphacode/tools/`.
