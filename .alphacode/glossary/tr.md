...
- PR #15835: https://github.com/anomalyco/alphacode/pull/15835

## Do Not Translate (Locale Additions)

- `AlphaCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `alphacode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `AlphaCode` in prose, `alphacode` only for exact technical identifiers
...
- Avoid changing `alphacode` to `AlphaCode` inside commands, URLs, package names, or code literals
