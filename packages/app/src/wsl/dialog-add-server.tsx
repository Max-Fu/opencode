...
import { showToast } from "@alphacode-ai/ui/toast"
...
import { LoaderV2 } from "@alphacode-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@alphacode-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-alphacode") {
      await run(() => api.installAlphacode(distro))
      return
    }
