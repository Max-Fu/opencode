...
import { makeApi } from "@alphacode-ai/protocol/api"
import { LocationMiddleware } from "@alphacode-ai/server/location"
import { SessionLocationMiddleware } from "@alphacode-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("alphacode-root")
...
export const InstanceHttpApi = HttpApi.make("alphacode-instance")
...
export const AlphaCodeHttpApi = HttpApi.make("alphacode")
