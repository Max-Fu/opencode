...
- PR #10018: https://github.com/anomalyco/alphacode/pull/10018
- PR #12935: https://github.com/anomalyco/alphacode/pull/12935

## Do Not Translate (Locale Additions)

- `AlphaCode` (preserve casing in prose; keep `alphacode` only in commands, package names, paths, or code)
- `AlphaCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
