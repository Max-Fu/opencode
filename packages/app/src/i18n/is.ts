...
const desktop = [
  ...
  "alphacode er ekki uppsett í þessari dreifingu",
  "alphacode er uppsett en ekki var hægt að keyra það",
...
export const dict = {
  ...
  "dialog.provider.alphacode.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.alphacode.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.alphacodeGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Heimsókn",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": "til að safna API lykilnum þínum.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode er tilbúið í {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode er tilbúinn.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode ekki uppsett",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (alphacode.json) þjónustuveitu/módelheiti",
