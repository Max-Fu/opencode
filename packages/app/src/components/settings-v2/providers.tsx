...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "alphacode", key: "dialog.provider.alphacode.note" },
  { match: (id: string) => id === "alphacode-go", key: "dialog.provider.alphacodeGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "alphacode" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "alphacode" || item.id === "alphacode-go"}>
