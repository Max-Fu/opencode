...
| `OPENCODE_ENABLE_AUTOUPDATE`          | boolean | Enable update checks (off by default)             |
...
| `OPENCODE_ENABLE_MODELS_FETCH`        | boolean | Fetch the model catalog remotely (off by default) |
