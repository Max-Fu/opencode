...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const alphacodeProjectID = input.model.providerID.startsWith("alphacode")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("alphacode")
        ? {
            ...(alphacodeProjectID ? { "x-alphacode-project": alphacodeProjectID } : {}),
            "x-alphacode-session": input.sessionID,
            "x-alphacode-request": input.user.id,
            "x-alphacode-client": input.flags.client,
