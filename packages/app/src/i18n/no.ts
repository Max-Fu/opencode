...
export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode er ikke installert i {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.alphacode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.alphacodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Besøk ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i alphacode.json",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (alphacode.json)",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode er klar i {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode er klar.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode er ikke installert",
