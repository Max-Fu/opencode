...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/alphacode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/alphacode...\n")
...
console.log("Fetching npm all-time downloads for alphacode-ai...\n")
const npmDownloads = await fetchNpmDownloads("alphacode-ai")
