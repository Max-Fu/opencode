...
beforeAll(async () => {
  ...
  mock.module("@alphacode-ai/sdk/v2/client", () => ({
    createAlphacodeClient: (input: { directory: string }) => {
      createdClients.push(input.directory)
      return clientFor(input.directory)
    },
  }))

  mock.module("@alphacode-ai/ui/toast", () => ({
    Toast: { Region: () => null },
    showToast: () => 0,
  }))

  mock.module("@alphacode-ai/core/util/encode", () => ({
