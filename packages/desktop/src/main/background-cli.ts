...
const desktopStateNames = ["ai.alphacode.desktop.dev", "ai.alphacode.desktop.beta", "ai.alphacode.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "alphacode-cli.exe" : "alphacode-cli"
}
