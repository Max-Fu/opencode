...
Agentferdigheter lar AlphaCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går alphacode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
alphacode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `alphacode.json`:
