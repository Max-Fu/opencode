...
export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "此發行版中未安裝 alphacode",
  "desktop.wsl.error.alphacodeCannotRun": "已安裝 alphacode，但無法執行",
  "desktop.wsl.error.alphacodeNotInstalled": "{{distro}} 中未安裝 AlphaCode",
  ...
  "dialog.provider.alphacode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.alphacode.tagline": "經過最佳化的可靠模型",
  "dialog.provider.alphacodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.alphacodeZen.line1": "AlphaCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.alphacodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.alphacodeZen.visit.prefix": "造訪 ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 alphacode.json 中設定的外掛程式",
  ...
  "wsl.onboarding.alphacodeReadyIn": "{{distro}} 中的 AlphaCode 已就緒。",
  "wsl.onboarding.alphacodeReady": "AlphaCode 已就緒。",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "未安裝 AlphaCode",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (alphacode.json) 中的 provider/model 名稱",
