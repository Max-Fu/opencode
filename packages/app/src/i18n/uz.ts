export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "Alphacode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode {{distro}} da o'rnatilmagan",
  ...
  "dialog.provider.alphacode.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.alphacode.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.alphacodeGo.tagline": "Hamma uchun arzon obuna",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " API kalitingizni olish uchun.",
  ...
  "dialog.plugins.empty": "alphacode.json da sozlangan plaginlar",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode {{distro}} da tayyor.",
  "wsl.onboarding.alphacodeReady": "AlphaCode tayyor.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode o'rnatilmagan",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (alphacode.json) provayder/model nomlarini tekshiring",
