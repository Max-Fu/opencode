---
title: Deling
description: Del dine AlphaCode-samtaler.
---

Delingsfunksjonen i AlphaCode lar deg lage offentlige lenker til dine AlphaCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, AlphaCode:
...
AlphaCode støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker AlphaCode manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `alphacode.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av alphacode i organisasjonen din.
