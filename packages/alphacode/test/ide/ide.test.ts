...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ALPHACODE_CALLER", () => {
    process.env["ALPHACODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ALPHACODE_CALLER", () => {
    process.env["ALPHACODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ALPHACODE_CALLER", () => {
    process.env["ALPHACODE_CALLER"] = "unknown"
