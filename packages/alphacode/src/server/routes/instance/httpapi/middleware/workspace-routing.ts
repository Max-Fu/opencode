...
>()("@alphacode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@alphacode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.ALPHACODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.ALPHACODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-alphacode-directory"] || process.cwd()
}
