export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "Alphacode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.alphacodeCannotRun": "Alphacode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode nuk është i instaluar në {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.alphacode.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.alphacodeGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Vizitoni ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode është gati në {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode është gati.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode nuk është i instaluar",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (alphacode.json).",
