...
export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "此发行版中未安装 alphacode",
  "desktop.wsl.error.alphacodeCannotRun": "已安装 alphacode，但无法运行",
  "desktop.wsl.error.alphacodeNotInstalled": "{{distro}} 中未安装 AlphaCode",
  ...
  "dialog.provider.alphacode.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.alphacode.tagline": "可靠的优化模型",
  "dialog.provider.alphacodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.alphacodeZen.line1": "AlphaCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.alphacodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.alphacodeZen.visit.prefix": "访问 ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "dialog.plugins.empty": "在 alphacode.json 中配置的插件",
  ...
  "wsl.onboarding.alphacodeReadyIn": "{{distro}} 中的 AlphaCode 已就绪。",
  "wsl.onboarding.alphacodeReady": "AlphaCode 已就绪。",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "未安装 AlphaCode",
  ...
  "error.chain.checkConfig": "请检查你的配置 (alphacode.json) 中的 provider/model 名称",
