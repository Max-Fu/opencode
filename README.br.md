...
brew install anomalyco/tap/alphacode # macOS e Linux (recomendado, sempre atualizado)
...
nix run nixpkgs#alphacode           # ou github:anomalyco/alphacode para a branch dev mais recente
```
...
O AlphaCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/anomalyco/alphacode/releases) ou em [alphacode.ai/download](https://alphacode.ai/download).
...
Saiba mais sobre [agents](https://alphacode.ai/docs/agents).

### Documentação

Para mais informações sobre como configurar o AlphaCode, [**veja nossa documentação**](https://alphacode.ai/docs).
...
**Junte-se à nossa comunidade** [Discord](https://discord.gg/alphacode) | [X.com](https://x.com/alphacode)
