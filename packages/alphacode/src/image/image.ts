...
export class Service extends Context.Service<Service, Interface>()("@alphacode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __ALPHACODE_PHOTON_WASM_PATH?: string }).__ALPHACODE_PHOTON_WASM_PATH =
