...
import { Switch } from "@alphacode-ai/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://alphacode.ai/docs/themes/">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_ALPHACODE_CHANNEL !== "prod"}>
          <SettingsRowV2
