...
Crea `.alphacode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di AlphaCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di AlphaCode:
...
- Globale: `~/.config/alphacode/commands/`
- Per progetto: `.alphacode/commands/`
...
alphacode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
