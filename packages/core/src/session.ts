...
import { ListAnchor } from "@alphacode-ai/schema/session"
...
import { SessionDurable } from "@alphacode-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/v2/Session") {}
