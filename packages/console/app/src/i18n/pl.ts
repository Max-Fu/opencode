...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | alphacode",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo alphacode",
  "notFound.logoDarkAlt": "ciemne logo alphacode",
  ...
  "temp.title": "alphacode | Agent AI do kodowania zbudowany dla terminala",
  ...
  "temp.feature.zen.afterLink": "dostarczana przez alphacode",
  ...
  "temp.logoLightAlt": "jasne logo alphacode",
  "temp.logoDarkAlt": "ciemne logo alphacode",
  ...
  "workspace.newUser.step.login.after": "i wybierz alphacode",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom alphacode i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług alphacode.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy alphacode",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wybierz "AlphaCode Go" jako dostawcę w konfiguracji alphacode, aby używać modeli Go.',
