...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | alphacode",
  "notFound.heading": "404 - Siden blev ikke fundet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "alphacode logo light",
  "notFound.logoDarkAlt": "alphacode logo dark",
  ...
  "temp.title": "alphacode | AI-kodningsagent bygget til terminalen",
  ...
  "temp.feature.zen.afterLink": "leveret af alphacode",
  ...
  "temp.screenshot.caption": "alphacode TUI med tokyonight-temaet",
  "temp.screenshot.alt": "alphacode TUI med tokyonight-temaet",
  "temp.logoLightAlt": "alphacode logo light",
  "temp.logoDarkAlt": "alphacode logo dark",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med alphacode, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg alphacode",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start alphacode og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API-nøgler for at få adgang til alphacode-tjenester.",
  "workspace.keys.create": "Opret API-nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en alphacode Gateway API-nøgle",
  ...
  "workspace.lite.subscription.selectProvider":
    'Vælg "AlphaCode Go" som udbyder i din alphacode-konfiguration for at bruge Go-modeller.',
