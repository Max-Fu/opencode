export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode не встановлено в {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.alphacode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.alphacodeGo.tagline": "Недорога підписка для всіх",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": ", щоб отримати ключ API.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode готовий до роботи.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode не встановлено",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (alphacode.json)",
