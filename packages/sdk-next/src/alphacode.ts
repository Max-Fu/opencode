import { AlphaCode } from "@alphacode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@alphacode-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("AlphaCode.create")(function* () {
  ...
  const client = yield* AlphaCode.make({ baseUrl: "http://alphacode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@alphacode-ai/sdk-next/AlphaCode") {}
