...
Desktop application and browser-based app issues, including `alphacode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core alphacode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

AlphaCode Zen, AlphaCode Go, and billing issues.
