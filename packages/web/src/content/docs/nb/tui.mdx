---
title: TUI
description: Bruke alphacode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AlphaCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre AlphaCode starter TUI for gjeldende katalog.
...
Når du bruker AlphaCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til AlphaCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt AlphaCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `alphacode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge AlphaCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `alphacode.default`.
