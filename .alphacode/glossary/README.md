...
Use this folder for locale-specific translation guidance that supplements `.alphacode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/alphacode/pull/12345

## Do Not Translate (Locale Additions)

- `AlphaCode` (preserve casing)
