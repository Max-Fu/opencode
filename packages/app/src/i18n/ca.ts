export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode no està instal·lat a {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.alphacode.tagline": "Models optimitzats fiables",
  "dialog.provider.alphacodeGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Visita ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " per recollir la teva clau API.",
  ...
  "dialog.plugins.empty": "Connectors configurats a alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode està llest a {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode està llest.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode no instal·lat",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (alphacode.json).",
