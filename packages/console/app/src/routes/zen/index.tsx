...
import compareVideo from "../../asset/lander/alphacode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/alphacode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="alphacode:auth" content={loggedin() ? "true" : "false"} />
