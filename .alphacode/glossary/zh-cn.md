...
- PR #13942: https://github.com/anomalyco/alphacode/pull/13942

## Do Not Translate (Locale Additions)

- `AlphaCode` (preserve casing in prose; keep `alphacode` only when it is part of commands, package names, paths, or code)
- `AlphaCode Zen`
- `AlphaCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `alphacode` in prose when referring to the product name; use `AlphaCode`
