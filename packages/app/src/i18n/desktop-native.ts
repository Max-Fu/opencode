...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode is not installed in this distro",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode is installed but could not run",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode is not installed in {{distro}}",
