...
import { compile, emitEffectImported, emitPromise, write } from "@alphacode-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "AlphaCodeEventEncoded",
              import: 'import type { AlphaCodeEventEncoded } from "@alphacode-ai/protocol/groups/event"',
            },
          },
        }),
