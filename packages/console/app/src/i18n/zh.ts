...
export const dict = {
  ...
  "notFound.logoLightAlt": "alphacode logo 亮色",
  "notFound.logoDarkAlt": "alphacode logo 暗色",
  ...
  "temp.logoLightAlt": "alphacode logo 亮色",
  "temp.logoDarkAlt": "alphacode logo 暗色",
  ...
  "workspace.lite.subscription.selectProvider":
    "在你的 alphacode 配置中选择「AlphaCode Go」作为提供商，即可使用 Go 模型。",
