...
brew install anomalyco/tap/alphacode # macOS et Linux (recommandé, toujours à jour)
...
nix run nixpkgs#alphacode           # ou github:anomalyco/alphacode pour la branche dev la plus récente
```
...
AlphaCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/anomalyco/alphacode/releases) ou [alphacode.ai/download](https://alphacode.ai/download).
...
En savoir plus sur les [agents](https://alphacode.ai/docs/agents).

### Documentation

Pour plus d'informations sur la configuration d'AlphaCode, [**consultez notre documentation**](https://alphacode.ai/docs).
...
**Rejoignez notre communauté** [Discord](https://discord.gg/alphacode) | [X.com](https://x.com/alphacode)
