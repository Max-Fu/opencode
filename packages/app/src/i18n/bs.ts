export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode nije instaliran u distribuciji {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.alphacode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.alphacodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Posjeti ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode je spreman.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode nije instaliran",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (alphacode.json)",
