export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode er ikki sett upp í hesi distro",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode er ikki sett upp í {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.alphacode.tagline": "Álítandi optimerað modell",
  "dialog.provider.alphacodeGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Vitja ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " fyri at savna tín API lykil.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode er klárt í {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode er klárt.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode ikki innstillað",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (alphacode.json) veitara/modell nøvn",
