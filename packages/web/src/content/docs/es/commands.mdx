...
Crear `.alphacode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración AlphaCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su AlphaCode [config](/docs/config):
...
- Por proyecto: `.alphacode/commands/`
...
alphacode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
