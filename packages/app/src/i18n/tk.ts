export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode {{distro}} gurulmady",
  ...
  "dialog.provider.alphacode.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.alphacode.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.alphacodeGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Sapar ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  ...
  "dialog.plugins.empty": "alphacode.json-de düzülen pluginler",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode {{distro}}-de taýýar.",
  "wsl.onboarding.alphacodeReady": "AlphaCode taýýar.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode gurulmady",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (alphacode.json) üpjün edijiniň / model atlaryny barlaň",
