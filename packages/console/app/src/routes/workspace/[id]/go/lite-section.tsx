...
import { Database, eq, and, isNull } from "@alphacode-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@alphacode-ai/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#alphacode-go")} target="_blank" rel="noopener noreferrer">
