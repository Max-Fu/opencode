...
//
// The saved variant persists across sessions in ~/.local/state/alphacode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@alphacode/RunVariant") {}
