...
import { Icon } from "@alphacode-ai/ui/v2/icon"
...
import { useTheme } from "@alphacode-ai/ui/theme"
...
const featuredProviders = ["alphacode", "alphacode-go", "openai", "anthropic", "google", "github-copilot"]
...
export const DialogSelectModelUnpaidV2: Component<{ model?: ModelState }> = (props) => {
  ...
  const isFree = (item: ReturnType<ModelState["list"]>[number]) =>
    item.provider.id === "alphacode" && (!item.cost || item.cost.input === 0)
