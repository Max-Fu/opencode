...
import { IconAlphacode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "alphacode/session/message-v2"
import type { Message } from "alphacode/session/message"
import type { Session } from "alphacode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.alphacode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.alphacode_name}>
                    <IconAlphacode width={16} height={16} />
                  </div>
