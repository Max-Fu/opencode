...
import { FileSystemWatcher } from "@alphacode-ai/schema/filesystem-watcher"
...
declare const ALPHACODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof ALPHACODE_LIBC === "undefined" ? undefined : ALPHACODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.ALPHACODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.ALPHACODE_EXPERIMENTAL_FILEWATCHER)) {
