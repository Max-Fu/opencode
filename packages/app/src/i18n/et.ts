export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode pole sellesse distrosse installitud",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode pole installitud asukohta {{distro}}",
  ...
  "dialog.provider.alphacode.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.alphacode.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.alphacodeGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "Külastage ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " API võtme kättesaamiseks.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode on valmis {{distro}}.",
  "wsl.onboarding.alphacodeReady": "AlphaCode on valmis.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode pole installitud",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (alphacode.json) pakkuja/mudeli nimesid",
