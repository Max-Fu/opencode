...
import type { Event, GlobalEvent, AlphacodeClient } from "@alphacode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@alphacode/RunStreamTransport") {}
