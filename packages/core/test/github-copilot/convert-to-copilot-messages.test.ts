import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@alphacode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
