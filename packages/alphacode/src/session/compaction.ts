...
import { buildPrompt } from "@alphacode-ai/core/session/compaction"
import { SessionCompactionEvent } from "@alphacode-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@alphacode/SessionCompaction") {}
