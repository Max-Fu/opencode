...
const GLOBAL_STORAGE = "alphacode.global.dat"
const WINDOW_STORAGE = "alphacode.window"
const LOCAL_PREFIX = "alphacode."
...
function workspaceStorage(dir: string) {
  ...
  return `alphacode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `alphacode.draft.${head}.${sum}.dat`
}
