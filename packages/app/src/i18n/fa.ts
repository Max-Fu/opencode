export const dict = {
  ...
  "desktop.wsl.error.alphacodeMissing": "alphacode در این توزیع نصب نشده است",
  "desktop.wsl.error.alphacodeCannotRun": "alphacode نصب شده است اما اجرا نمی شود",
  "desktop.wsl.error.alphacodeNotInstalled": "AlphaCode در {{distro}} نصب نشده است",
  ...
  "dialog.provider.alphacode.note": "مدل های انتخاب شده از جمله Claude، GPT، Gemini و موارد دیگر",
  "dialog.provider.alphacode.tagline": "مدل های بهینه شده قابل اعتماد",
  "dialog.provider.alphacodeGo.tagline": "اشتراک کم هزینه برای همه",
  ...
  "provider.connect.alphacodeZen.visit.prefix": "بازدید کنید ",
  "provider.connect.alphacodeZen.visit.link": "alphacode.ai/zen",
  "provider.connect.alphacodeZen.visit.suffix": " برای جمع آوری کلید API.",
  ...
  "dialog.plugins.empty": "پلاگین های پیکربندی شده در alphacode.json",
  ...
  "wsl.onboarding.alphacodeReadyIn": "AlphaCode در {{distro}} آماده است.",
  "wsl.onboarding.alphacodeReady": "AlphaCode آماده است.",
  ...
  "wsl.onboarding.distroStatus.alphacodeMissing": "AlphaCode نصب نشده است",
  ...
  "error.chain.checkConfig": "نام ارائه دهنده/مدل پیکربندی (alphacode.json) خود را بررسی کنید",
